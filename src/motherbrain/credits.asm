...
tilemap_data:
    ...
    dw "                                "   
    dw "                                "   
    !PURPLE : dw "LEGEND OF ZELDA " : !YELLOW : dw "         METROID"
    dw "                                "
    !PURPLE : dw "HIROSHI YAMAUCHI" : !YELLOW : dw "    MAKOTO KANOH"
    !PURPLE : dw "SHIGERU MIYAMOTO" : !YELLOW : dw " YOSHIO SAKAMOTO"
    !PURPLE : dw "TAKASHI TEZUKA" : !YELLOW : dw "      TOHRU OHSAWA"
    !PURPLE : dw "TOSHIHIKO NAKAGO" : !YELLOW : dw " HIROKAZU TANAKA"
    !PURPLE : dw "YASUNARI SOEJIMA" : !YELLOW : dw " HIROJI KIYOTAKE"
    !PURPLE : dw "I. MARUI      " : !YELLOW : dw " HIROFUMA MATSUOKA"
    !PURPLE : dw "KOJI KONDO" : !YELLOW : dw "       HIROYUKI YUKAMI"
    !PURPLE : dw "          " : !YELLOW : dw "         YASE SOBAJIMA"
    !PURPLE : dw "          " : !YELLOW : dw "        TOSHIO SENGOKU"
    !PURPLE : dw "          " : !YELLOW : dw "           N. SHIOTANI"
    !PURPLE : dw "          " : !YELLOW : dw "             M. HOUDAI"
    !PURPLE : dw "          " : !YELLOW : dw "         TORU NARIHIRO"
    !PURPLE : dw "          " : !YELLOW : dw "          SATORU OKADA"
    !PURPLE : dw "          " : !YELLOW : dw "          GUNPEI YOKOI"
    !PURPLE : dw "          " : !YELLOW : dw "      HIROSHI YAMAUCHI"
...
.end_sprite_credits
    ...
    dw "        solski      andy        "
    dw "                                "
    dw "     OSSE101      CROSSPRODUCT  "
    dw "     osse!}!      crossproduct  "
    dw "                                "
    dw "    LACKATTACK   METALMACHINE   "
    dw "    lackattack   metalmachine   "
    dw "                                "
    dw "                                "
    dw "                                "
    ...
    dw "                                "
    !CYAN
    dw "   THE REST OF THE CREDITS HAS  "
    dw "      NOT BEEN UPDATED YET      "
    dw "                                "
    dw "       THANKS FOR TESTING       "
    dw "                                "
    dw "                                "
    !PURPLE
    dw "          SUPER METROID         "
