...
ItemData:
    ...
    dw $0000, $0020, $0022, $0000        ; C0 - Energy Tank             (SM)
    dw $0000, $0032, $0023, $0000        ; C1 - Reserve tank            (SM)
    dw $0000, $0024, $0024, $0000        ; C2 - Missile                 (SM)
    dw $0000, $0028, $0024, $0000        ; C3 - Super Missile           (SM)
    dw $0000, $002c, $0024, $0000        ; C4 - Power Bomb              (SM)
