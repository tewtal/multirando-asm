...
; Custom boot routine for Z1 SNES
SnesBoot:
    JMP SnesInit : .ret

    ; Copy common routines to WRAM
    REP #$30
    LDX #$0000
-
...
SnesInit:
  ...
  LDX $0FFD		;we clear all the mem at one point ...
...
_Loop03:		;regs $2123-$2133
  ...
  LDA #$01 : STA $420D		;reg $420D  - ROM access time to slow (2.68Mhz)
...
_Loop09:
  ...
  ; Set up some PPU stuff (Mode 1, BG0 / Sprites on, 32x64 tilemap)
  LDA #$20
  STA $2107
